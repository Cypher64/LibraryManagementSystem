...
class Book(models.Model):
    def __str__(self):
        return self.title
    publishing = models.ForeignKey('Publishing', models.DO_NOTHING, blank=True, null=True)
...
class Loans(models.Model):
    book = models.ForeignKey(Bookauthors, models.DO_NOTHING, blank=True, null=True)
    readers = models.ForeignKey('Readers', models.DO_NOTHING, blank=True, null=True)
...
class Readers(models.Model):
    ...
    phone = models.CharField(db_column='Phone', unique=True, max_length=20, blank=True, null=True)  # Field name made lowercase.
